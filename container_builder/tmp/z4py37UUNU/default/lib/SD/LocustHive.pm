...
# XXX:  A list of environment variables in the form of VAR=value
has env => (
    is => 'ro',
);
...
# XXX: This should have a default based on WS/SD Platform ..?
has location => (
    is => 'ro',
);
...
# This should come from SD_PLATFORM .. but doesn't exist yet.
has base_uri => (
    is      => 'ro',
